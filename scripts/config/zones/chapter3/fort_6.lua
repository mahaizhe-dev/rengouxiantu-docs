...
-- 区域 (56,8)→(71,23)，内部可用约 (58,10)→(69,21)，均匀散布
fort_6.spawns = {
    { type = "sand_demon_6", x = 60, y = 12 },
    { type = "sand_demon_6", x = 66, y = 11 },
    { type = "sand_demon_6", x = 58, y = 15 },
    { type = "sand_demon_6", x = 63, y = 14 },
    { type = "sand_demon_6", x = 68, y = 17 },
    { type = "sand_demon_6", x = 60, y = 19 },
