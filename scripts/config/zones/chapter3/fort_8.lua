...
-- 区域 (32,8)→(47,23)，内部可用约 (34,10)→(45,21)，全区域均匀散布
fort_8.spawns = {
    { type = "sand_scorpion_8", x = 36, y = 12 },
    { type = "sand_scorpion_8", x = 43, y = 11 },
    { type = "sand_scorpion_8", x = 35, y = 15 },
    { type = "sand_scorpion_8", x = 42, y = 14 },
    { type = "sand_scorpion_8", x = 37, y = 18 },
    { type = "sand_scorpion_8", x = 44, y = 19 },
    { type = "sand_scorpion_8", x = 38, y = 13 },
