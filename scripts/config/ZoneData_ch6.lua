...
ZoneData_ch6.FUTURE_DUNGEON_BARRIERS = {
    tiger_trial = {
        ...
        edgeBreakup = {
            ...
            { x = 58, y = 26, tile = "GRASS" },
            { x = 62, y = 26, tile = "GRASS" },
            { x = 75, y = 26, tile = "GRASS" },
...
ZoneData_ch6.NPCs = {
    ...
    -- ── 呱大人湖心岛：天青白莲暂未开放交互物件 ──
    {
        id = "ch6_qingbai_lotus_nw", name = "天青白莲", subtitle = "",
        x = 8.5, y = 71.5, icon = "✿",
        interactType = "coming_soon", zone = "boar_forest",
        ...
        dialog = "天青白莲含苞吐辉，尚未苏醒。\n\n暂未开放。",
    },
    {
        id = "ch6_qingbai_lotus_ne", name = "天青白莲", subtitle = "",
        x = 14.5, y = 71.5, icon = "✿",
        interactType = "coming_soon", zone = "boar_forest",
        isObject = true, decorationType = "qingbai_lotus",
        image = "image/qingbai_lotus_interactive_object_20260701004120.png",
    ...
    {
        id = "ch6_qingbai_lotus_sw", name = "天青白莲", subtitle = "",
        x = 8.5, y = 76.5, icon = "✿",
        interactType = "coming_soon", zone = "boar_forest",
        isObject = true, decorationType = "qingbai_lotus",
        image = "image/qingbai_lotus_interactive_object_20260701004120.png",
    ...
    {
        id = "ch6_qingbai_lotus_se", name = "天青白莲", subtitle = "",
        x = 14.5, y = 76.5, icon = "✿",
        interactType = "coming_soon", zone = "boar_forest",
        isObject = true, decorationType = "qingbai_lotus",
        image = "image/qingbai_lotus_interactive_object_20260701004120.png",
