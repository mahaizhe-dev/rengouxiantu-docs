...
ZoneData_ch6.NPCs = {
    ...
    -- ── 百宝箱（复用前五章仓库系统） ──
    {
        id = "warehouse_chest_ch6", name = "百宝箱", subtitle = "存取物品",
        x = 78, y = 37, icon = "📦",
        image = "image/warehouse_chest_20260331104459.png",
        imageScale = 1.0,
        interactType = "warehouse", zone = "shadow_spawn_safe",
        isObject = true,
    ...
    -- ── 两界影炉（第六章仙1终局打造） ──
    {
        ...
        x = 72.5,
        y = 43.5,
        image = "image/furnace_3x3_20260515085411.png",
        portrait = "image/furnace_3x3_20260515085411.png",
        interactType = "shadow_forge",
        isObject = true,
        hideName = false,
        showNameplate = true,
        zone = "shadow_spawn_safe",
        label = "两界影炉",
        dialog = "影炉吞吐两界幽光，可用影子水晶将旧章圣器与第六章遗珍合铸为仙1终局装备。",
    },
    -- ── 第六章神器：界匙（村口东侧，2x2 占地：55~56, 40~41） ──
    {
        id = "ch6_divine_jieshi",
        name = "界匙",
        subtitle = "第六章神器",
        x = 55.5, y = 40.5,
        footprint = { x = 55, y = 40, w = 2, h = 2 },
        icon = "◇",
        interactType = "divine_jieshi",
        zone = "narrow_trail",
        isObject = true,
        decorationType = "divine_jieshi",
        image = "image/ch6_jieshi_world_artifact_20260711011456.png",
        imageScale = 1.7,
        nameplateOffset = 1.82,
        hideName = false,
        showNameplate = true,
        color = {155, 220, 255, 255},
        dialog = "残缺界匙悬于两界村口，九枚钥片围绕中央钥孔缓慢转动。集齐碎片可逐格重铸神器。",
    },
    -- ── 两界村外四角：两界阵石 ──
    {
        id = "ch6_liangjie_stone_xuanbi", stoneId = "xuanbi",
        name = "玄壁阵石", subtitle = "未激活",
        x = 32, y = 32, icon = "◆",
        interactType = "liangjie_stone", zone = "wilderness",
        isObject = true, decorationType = "liangjie_stone",
        image = "image/ch6_liangjie_array_stone_20260710105731.png",
        imageScale = 1.34, imageAspect = 768 / 515,
        nameplateOffset = 1.72, hideName = false, showNameplate = true,
        color = {110, 175, 235, 255},
        dialog = "玄壁阵石镇守村外西北，石纹中沉睡着护界之力。",
    },
    {
        id = "ch6_liangjie_stone_tianfeng", stoneId = "tianfeng",
        name = "天锋阵石", subtitle = "未激活",
        x = 49, y = 32, icon = "◆",
        interactType = "liangjie_stone", zone = "wilderness",
        isObject = true, decorationType = "liangjie_stone",
        image = "image/ch6_liangjie_array_stone_20260710105731.png",
        ...
        dialog = "天锋阵石镇守村外东北，石锋间残留着破界锐气。",
    },
    {
        id = "ch6_liangjie_stone_houtu", stoneId = "houtu",
        name = "厚土阵石", subtitle = "未激活",
        x = 32, y = 49, icon = "◆",
        interactType = "liangjie_stone", zone = "wilderness",
        isObject = true, decorationType = "liangjie_stone",
        image = "image/ch6_liangjie_array_stone_20260710105731.png",
        ...
        dialog = "厚土阵石镇守村外西南，厚重灵机与地脉相连。",
    },
    {
        id = "ch6_liangjie_stone_huiyuan", stoneId = "huiyuan",
        name = "回元阵石", subtitle = "未激活",
        x = 49, y = 49, icon = "◆",
        interactType = "liangjie_stone", zone = "wilderness",
        isObject = true, decorationType = "liangjie_stone",
        image = "image/ch6_liangjie_array_stone_20260710105731.png",
...
-- 开发期世界部署审计：只检查本章新增的关键交互入口。
ZoneData_ch6.REQUIRED_NPC_IDS = {
    "warehouse_chest_ch6",
    "ch6_shadow_forge",
    "ch6_divine_jieshi",
