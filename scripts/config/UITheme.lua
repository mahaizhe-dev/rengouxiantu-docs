...
UITheme.color = {
    ...
    -- ▼ 新增：套装色（附灵系统） ────────────────────
    setXuesha     = {255, 80,  80,  255}, -- 血煞套装（红）
    setQingyun    = {80,  160, 255, 255}, -- 青云套装（蓝）
    setFengmo     = {180, 80,  255, 255}, -- 封魔套装（紫）
    setHaoqi      = {255, 210, 60,  255}, -- 浩气套装（金）
    ...
    -- ▼ 锻造/打造系统 ────────────────────────────────
    forgeBorderGold    = {200, 160, 40, 180},   -- 铸剑地炉金色边框
    forgeBorderRed     = {200, 80, 80, 180},    -- 龙神/圣器红边框
    forgeBorderPurple  = {160, 100, 220, 180},  -- 诛仙阵图紫边框

    -- ▼ 材料状态 ─────────────────────────────────────
    matEnough          = {130, 230, 130, 255},  -- 材料充足（绿）
    matInsufficient    = {255, 130, 100, 255},  -- 材料不足（红）

    -- ▼ 属性值显示 ───────────────────────────────────
    statValueGold      = {255, 215, 0, 255},    -- 主属性金色值
    statValueGreen     = {150, 255, 150, 255},  -- 副属性绿色值
    statValueCyan      = {0, 230, 230, 255},    -- 灵性属性青色值
    statValueRed       = {255, 80, 80, 255},    -- 圣性属性红色值

    -- ▼ 神器格子状态 ─────────────────────────────────
    artifactActivated  = {80, 220, 100, 255},   -- 已激活格子边框
    artifactReady      = {255, 215, 0, 255},    -- 可激活格子边框
    artifactLocked     = {50, 50, 60, 120},     -- 未解锁格子边框
    ...
    -- ── 传送面板（tp）──
    tpBadgeFan        = {40, 110, 50, 230},     -- "凡" 标签底色（深绿偏亮）
    tpBadgeXian       = {90, 50, 140, 230},     -- "仙" 标签底色（深紫偏亮）
    tpBadgeSpecial    = {130, 100, 30, 230},    -- "特" 标签底色（暗金）
    tpBadgeText       = {240, 240, 255, 255},   -- 标签文字色（更亮）
    tpLockText        = {160, 155, 140, 220},   -- "暂未开启" 文字色
    tpReqText         = {255, 180, 100, 240},   -- 未解锁条件文字（暖橙警告）
}
...
UITheme.size = {
    -- 按钮/图标
    skillButton    = 50,   -- 技能按钮（适配手机竖屏）
    toolButton     = 42,   -- 底栏工具按钮（宠物/突破/背包）
    closeButton    = 36,   -- 关闭按钮
    ...
    bottomBarMaxW  = 530,  -- 底部栏最大宽度（适配手机竖屏）
