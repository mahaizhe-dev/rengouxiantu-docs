...
SwordPoolConfig.SWORDS = {
    zhu = {
        ...
        name = "诛仙剑封印",
        icon = "⚔️",
        image = "image/icon_fengyin_zhuxian_ch5_20260517105215.png",
        color = {200, 60, 40, 255},
    ...
    xian = {
        ...
        name = "陷仙剑封印",
        icon = "🗡️",
        image = "image/icon_fengyin_xianxian_ch5_20260517110530.png",
        color = {40, 80, 200, 255},
    ...
    lu = {
        ...
        name = "戮仙剑封印",
        icon = "🔪",
        image = "image/icon_fengyin_luxian_ch5_20260517105218.png",
        color = {60, 180, 60, 255},
    ...
    jue = {
        ...
        name = "绝仙剑封印",
        icon = "💀",
        image = "image/icon_fengyin_juexian_ch5_20260517110452.png",
