...
-- P0-S2: 可选章节神器模块 pcall 保护（单模块故障不应阻止进入游戏）
local _ok, ArtifactUI_ch4 = pcall(require, "ui.ArtifactUI_ch4")
if not _ok then print("[WARN] ArtifactUI_ch4 load failed: " .. tostring(ArtifactUI_ch4)); ArtifactUI_ch4 = nil end
local _ok2, ArtifactUI_ch5 = pcall(require, "ui.ArtifactUI_ch5")
if not _ok2 then print("[WARN] ArtifactUI_ch5 load failed: " .. tostring(ArtifactUI_ch5)); ArtifactUI_ch5 = nil end
local _ok3, ArtifactUI_tiandi = pcall(require, "ui.ArtifactUI_tiandi")
if not _ok3 then print("[WARN] ArtifactUI_tiandi load failed: " .. tostring(ArtifactUI_tiandi)); ArtifactUI_tiandi = nil end
local _ok4, ArtifactSystem_ch4 = pcall(require, "systems.ArtifactSystem_ch4")
if not _ok4 then print("[WARN] ArtifactSystem_ch4 load failed: " .. tostring(ArtifactSystem_ch4)); ArtifactSystem_ch4 = nil end
local _ok5, ArtifactSystem_ch5 = pcall(require, "systems.ArtifactSystem_ch5")
...
function HandleUpdate(eventType, eventData)
    ...
    -- 第五章神器BOSS战流程（诛仙阵图·太虚竞技场）
    ArtifactUI_ch5.TryStartPendingBossFight(gameMap_, camera_)
    ArtifactSystem_ch5.UpdateBossArena(dt, gameMap_, camera_)
    ArtifactUI_ch5.Update(dt)
