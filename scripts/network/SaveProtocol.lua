...
SaveProtocol.C2S_SaveGameBegin  = "C2S_SaveGameBegin"
SaveProtocol.C2S_SaveGameChunk  = "C2S_SaveGameChunk"
SaveProtocol.C2S_SaveGameCommit = "C2S_SaveGameCommit"
...
SaveProtocol.C2S_CheckEventGrant  = "C2S_CheckEventGrant"      -- 查询 event_grant 道印（代查排行榜）
SaveProtocol.C2S_CheckRaceSlots   = "C2S_CheckRaceSlots"       -- 查询竞速道印名额状态
SaveProtocol.C2S_RedeemAck        = "C2S_RedeemAck"            -- 兑换码奖励确认回执
SaveProtocol.C2S_ServerApiTest    = "C2S_ServerApiTest"        -- 服务端 API 验证(C4/C5)
-- 皮肤商店（大黑无天）
SaveProtocol.C2S_SkinShopQuery = "C2S_SKQuery"       -- 查询皮肤商店（已解锁+仙石）
SaveProtocol.C2S_SkinShopBuy   = "C2S_SKBuy"         -- 购买皮肤
SaveProtocol.S2C_SkinShopData   = "S2C_SKData"       -- 皮肤商店数据
SaveProtocol.S2C_SkinShopResult = "S2C_SKResult"     -- 购买结果
-- 万界黑商
...
-- BOSS 里程碑协议字段名（前后端共用单一数据源，防止字段错位，如历史上的 Target/Milestone 错配）
SaveProtocol.MS_F_Milestone       = "Milestone"        -- 档位 target（请求 & 回包）
SaveProtocol.MS_F_ClientBossKills = "ClientBossKills"  -- 客户端实时全局击杀（请求）
SaveProtocol.MS_F_EventId         = "EventId"          -- 活动ID（回包）
SaveProtocol.MS_F_BossKills       = "BossKills"        -- 活动击杀数（回包，非全局累计）
SaveProtocol.MS_F_Claimed         = "Claimed"          -- 已领取map JSON（查询回包）/ bool（领取回包）
SaveProtocol.MS_F_Rewards         = "Rewards"          -- 奖励JSON（领取回包）
-- 仙缘宝箱
SaveProtocol.C2S_XianyuanChest_StartOpen    = "C2S_XCStart"      -- 请求开始解封
SaveProtocol.C2S_XianyuanChest_CancelOpen   = "C2S_XCCancel"     -- 取消读条
SaveProtocol.C2S_XianyuanChest_CompleteOpen = "C2S_XCComplete"   -- 读条完成
SaveProtocol.C2S_XianyuanChest_Pick         = "C2S_XCPick"       -- 选择奖励（1/2/3）
-- 乌家宝藏
SaveProtocol.C2S_WubaoTreasure_StartOpen    = "C2S_WBStart"      -- 请求开箱前校验
SaveProtocol.C2S_WubaoTreasure_CancelOpen   = "C2S_WBCancel"     -- 取消开箱状态
SaveProtocol.C2S_WubaoTreasure_CompleteOpen = "C2S_WBComplete"   -- 完成开箱结算
-- 藏宝图
SaveProtocol.C2S_TreasureMap_QueryState   = "C2S_TMQuery"
SaveProtocol.C2S_TreasureMap_Use          = "C2S_TMUse"
SaveProtocol.C2S_TreasureMap_Continue     = "C2S_TMContinue"
SaveProtocol.C2S_TreasureMap_StartOpen    = "C2S_TMStart"
SaveProtocol.C2S_TreasureMap_CompleteOpen = "C2S_TMComplete"
SaveProtocol.C2S_TreasureMap_CancelOpen   = "C2S_TMCancel"
SaveProtocol.C2S_TreasureMap_Abandon      = "C2S_TMAbandon"
SaveProtocol.C2S_TreasureMap_Exit         = "C2S_TMExit"
-- 多人副本（四兽岛）
...
SaveProtocol.S2C_LoadGameBegin = "S2C_LoadGameBegin"
SaveProtocol.S2C_LoadGameChunk = "S2C_LoadGameChunk"
SaveProtocol.S2C_LoadGameEnd   = "S2C_LoadGameEnd"
...
SaveProtocol.S2C_CheckEventGrantResult = "S2C_CheckEventGrantResult" -- event_grant 道印查询结果
SaveProtocol.S2C_CheckRaceSlotsResult  = "S2C_CheckRaceSlotsResult"  -- 竞速道印名额查询结果
...
SaveProtocol.S2C_XianyuanChest_PickResult  = "S2C_XCPickResult"   -- 选择奖励结果
-- 乌家宝藏
SaveProtocol.S2C_WubaoTreasure_StartResult = "S2C_WBStartResult"  -- 开箱前校验结果
SaveProtocol.S2C_WubaoTreasure_OpenResult  = "S2C_WBOpenResult"   -- 开箱发奖结果
-- 藏宝图
SaveProtocol.S2C_TreasureMap_State           = "S2C_TMState"
SaveProtocol.S2C_TreasureMap_UseResult       = "S2C_TMUseResult"
SaveProtocol.S2C_TreasureMap_StartOpenResult = "S2C_TMStartResult"
SaveProtocol.S2C_TreasureMap_OpenResult      = "S2C_TMOpenResult"
SaveProtocol.S2C_TreasureMap_AbandonResult   = "S2C_TMAbandonResult"
SaveProtocol.S2C_TreasureMap_ExitResult      = "S2C_TMExitResult"
-- 多人副本（四兽岛）
...
-- 剑气长城副本
SaveProtocol.C2S_SwordWallStart     = "C2S_SWStart"        -- 副本开始注册（防伪造）
...
-- 触发式战斗副本
SaveProtocol.C2S_TriggeredBattleStart  = "C2S_TBStart"       -- 请求开始触发战斗
SaveProtocol.C2S_TriggeredBattleFinish = "C2S_TBFinish"      -- 触发战斗胜利结算
SaveProtocol.S2C_TriggeredBattleStartResult  = "S2C_TBStartResult"  -- 开始校验结果
SaveProtocol.S2C_TriggeredBattleFinishResult = "S2C_TBFinishResult" -- 奖励结算结果
-- 心跳（P1 阶段 1：被动观测，不改行为）
SaveProtocol.C2S_Heartbeat    = "C2S_Heartbeat"        -- 客户端心跳
SaveProtocol.S2C_Heartbeat    = "S2C_Heartbeat"        -- 服务端心跳 ACK
-- 诊断上报（C+：内建遥测，不改行为）
SaveProtocol.C2S_NetDiagReport = "C2S_NetDiagReport"   -- 客户端诊断摘要
-- 通用
...
SaveProtocol.ALL_EVENTS = {
    ...
    SaveProtocol.C2S_SaveGameBegin,
    SaveProtocol.C2S_SaveGameChunk,
    SaveProtocol.C2S_SaveGameCommit,
    ...
    SaveProtocol.C2S_CheckEventGrant,
    SaveProtocol.C2S_CheckRaceSlots,
    ...
    SaveProtocol.S2C_LoadGameBegin,
    SaveProtocol.S2C_LoadGameChunk,
    SaveProtocol.S2C_LoadGameEnd,
    ...
    SaveProtocol.S2C_CheckEventGrantResult,
    SaveProtocol.S2C_CheckRaceSlotsResult,
    SaveProtocol.S2C_ServerApiTestResult,
    -- 皮肤商店
    SaveProtocol.C2S_SkinShopQuery,
    SaveProtocol.C2S_SkinShopBuy,
    SaveProtocol.S2C_SkinShopData,
    SaveProtocol.S2C_SkinShopResult,
    -- 万界黑商
    ...
    SaveProtocol.C2S_XianyuanChest_CompleteOpen,
    SaveProtocol.C2S_XianyuanChest_Pick,
    SaveProtocol.S2C_XianyuanChest_StartResult,
    SaveProtocol.S2C_XianyuanChest_Reward,
    SaveProtocol.S2C_XianyuanChest_PickResult,
    -- 乌家宝藏
    SaveProtocol.C2S_WubaoTreasure_StartOpen,
    SaveProtocol.C2S_WubaoTreasure_CancelOpen,
    SaveProtocol.C2S_WubaoTreasure_CompleteOpen,
    SaveProtocol.S2C_WubaoTreasure_StartResult,
    SaveProtocol.S2C_WubaoTreasure_OpenResult,
    -- 藏宝图
    SaveProtocol.C2S_TreasureMap_QueryState,
    SaveProtocol.C2S_TreasureMap_Use,
    SaveProtocol.C2S_TreasureMap_Continue,
    SaveProtocol.C2S_TreasureMap_StartOpen,
    SaveProtocol.C2S_TreasureMap_CompleteOpen,
    SaveProtocol.C2S_TreasureMap_CancelOpen,
    SaveProtocol.C2S_TreasureMap_Abandon,
    SaveProtocol.C2S_TreasureMap_Exit,
    SaveProtocol.S2C_TreasureMap_State,
    SaveProtocol.S2C_TreasureMap_UseResult,
    SaveProtocol.S2C_TreasureMap_StartOpenResult,
    SaveProtocol.S2C_TreasureMap_OpenResult,
    SaveProtocol.S2C_TreasureMap_AbandonResult,
    SaveProtocol.S2C_TreasureMap_ExitResult,
    -- 多人副本（四兽岛）
    ...
    -- 剑气长城副本
    SaveProtocol.C2S_SwordWallStart,
    ...
    -- 触发式战斗副本
    SaveProtocol.C2S_TriggeredBattleStart,
    SaveProtocol.C2S_TriggeredBattleFinish,
    SaveProtocol.S2C_TriggeredBattleStartResult,
    SaveProtocol.S2C_TriggeredBattleFinishResult,
    -- 心跳 + 诊断
    SaveProtocol.C2S_Heartbeat,
    SaveProtocol.S2C_Heartbeat,
    SaveProtocol.C2S_NetDiagReport,
    -- 通用
