...
for _, spec in ipairs({
    ...
    { id = "tiger_king", food = "immortal_bone", chance = 0.15, expected = 45 },
    ...
    { id = "xueshameng_corpse", food = "spirit_meat", chance = 0.35, expected = 28 },
    { id = "haoqizong_corpse", food = "spirit_meat", chance = 0.35, expected = 28 },
    { id = "wu_blood_puppet", food = "spirit_meat", chance = 0.35, expected = 28 },
    { id = "boar_boss_ch2", food = "beast_meat", chance = 0.25, expected = 40 },
    { id = "snake_king", food = "beast_meat", chance = 0.30, expected = 48 },
    { id = "wu_dibei", food = "beast_meat", chance = 0.35, expected = 56 },
    ...
    { id = "wu_wanchou", food = "beast_meat", chance = 0.45, expected = 72 },
    { id = "wu_wanhai", food = "immortal_bone", chance = 0.30, expected = 90 },
}) do
    checkFood(spec)
end
