---@diagnostic disable
-- ============================================================================
-- ArtifactSystem_tiandi.lua - 天帝剑痕神器系统（中洲战场）
-- 碎片收集 → 格子激活 → 属性加成
-- 当前实现：仙劫战场三片（壹贰叁）+ 仙殒战场三片（肆伍陆），仙灭战场待后续扩展
-- BOSS战和被动技能：待后续实现
-- ============================================================================
...
ArtifactTiandi.FRAGMENT_IDS = {
    ...
    "tiandi_fragment_4",   -- 碎片·肆（仙殒战场·域外天魔）
    "tiandi_fragment_5",   -- 碎片·伍（仙殒战场·域外天魔）
    "tiandi_fragment_6",   -- 碎片·陆（仙殒战场·域外天魔）
    -- 碎片·柒~玖（仙灭战场，待实现后追加）
}
...
--- 当前已实现的格子数量（仙劫3 + 仙殒3 = 6）
ArtifactTiandi.GRID_COUNT = 6
