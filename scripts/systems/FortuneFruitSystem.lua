...
FortuneFruitSystem.FRUITS = {
    ...
    -- 第五章·太虚之殇（10个：各区域偏僻可到达处）
    -- 区域范围参照 ZoneData_ch5.LAYOUT
    [5] = {
        { x = 12, y = 6  },  -- 问剑坪 (x1=3,y1=3,x2=22,y2=17) 中偏左侧
        { x = 67, y = 8  },  -- 洗剑寒池 (x1=58,y1=3,x2=77,y2=17) 中偏右侧
        { x = 8,  y = 30 },  -- 铸剑地炉 (x1=3,y1=20,x2=18,y2=35) 中偏左侧
        { x = 63, y = 28 },  -- 悟剑碑林（北） (x1=58,y1=20,x2=77,y2=45) 北段
        { x = 71, y = 42 },  -- 悟剑碑林（南） (x1=58,y1=20,x2=77,y2=45) 南段
        { x = 65, y = 55 },  -- 藏经阁 (x1=58,y1=48,x2=77,y2=64) 中段
        { x = 8,  y = 45 },  -- 栖剑别院（北） (x1=3,y1=38,x2=22,y2=64) 北段
        { x = 15, y = 58 },  -- 栖剑别院（南） (x1=3,y1=38,x2=22,y2=64) 南段
        { x = 32, y = 54 },  -- 镇魔深渊（西） (x1=26,y1=49,x2=54,y2=68) 西段
        { x = 48, y = 62 },  -- 镇魔深渊（东） (x1=26,y1=49,x2=54,y2=68) 东段
    },
    -- 第六章·两界村之影（10个：影入口、荒原、两界山、东西大营、呱大人领地分散）
    [6] = {
        { x = 74, y = 35 },  -- 影入口北侧
        { x = 78, y = 45 },  -- 影入口东南角
        { x = 35, y = 24 },  -- 影游荒原西北
